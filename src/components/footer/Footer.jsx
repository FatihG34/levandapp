...
const Footer = () => {
    ...
    return (
        <div>
            ...
            <footer className="footer px-5 py-1 border-t bg-base-200 text-base-content border-base-300">
                ...
                <div className="md:place-self-center md:justify-self-end">
                    <div className="grid grid-flow-col gap-3">
                        ...
                        <a title="Fatih's LinkedIn" href="https://www.linkedin.com/in/fatih-gunaydin/" target={'_blank'}><svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 24 24" className="fill-current"><g> <path fill="none" d="M0 0h24v24H0z" /> <path fillRule="nonzero" d="M6.94 5a2 2 0 1 1-4-.002 2 2 0 0 1 4 .002zM7 8.48H3V21h4V8.48zm6.32 0H9.34V21h3.94v-6.57c0-3.66 4.77-4 4.77 0V21H22v-7.93c0-6.17-7.06-5.94-8.72-2.91l.04-1.68z" /> </g></svg></a>
