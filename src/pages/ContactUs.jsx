...
const ContactUs = () => {
    return (
        <div className="container my-48 px-4 mx-auto">
                                ...
                                <div className="mb-12 grow-0 shrink-0 basis-auto w-full md:w-6/12 lg:w-full xl:w-6/12 px-3 md:px-6 xl:px-12">
                                    <div className="flex items-start">
                                        <div className="shrink-0">
                                            <div className="p-4 bg-lime-600 rounded-md shadow-md w-14 h-14 flex items-center justify-center">
                                        ...
                                        <div className="grow ml-6">
                                            ...
                                            <p className="text-gray-500">hm@levand.com.tr</p>
                                            <p className="text-gray-500"><span><em>Telephone Number :</em></span> +90 (212) 260 - 0015</p>
                                            <p className="text-gray-500"><span><em>Fax Number :</em></span> +90 (212) 227 - 0015</p>
                                        </div>
                                    </div>
                                </div>
                                <div className="mb-12 grow-0 shrink-0 basis-auto w-full md:w-6/12 lg:w-full xl:w-6/12 px-3 md:px-6 xl:px-12">
