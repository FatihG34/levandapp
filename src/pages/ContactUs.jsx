...
const ContactUs = () => {
    ...
    return (
        <section className="flex justify-center items-center -mt-[4.75rem] h-[calc(100vh+10rem)] bg-[conic-gradient(at_top,_var(--tw-gradient-stops))] from-[#BF815E] via-[#F2C49B] to-[#BF815E]">
